...
BuildRequires:  mingw32-spice-gtk3 >= 0.22
BuildRequires:  mingw64-spice-gtk3 >= 0.22
...
BuildRequires:  msitools >= 0.93.75-2
...
cp build_win32$MINGW_BUILDDIR_SUFFIX/data/virt-viewer-x86-2.0.msi $RPM_BUILD_ROOT/%{mingw32_datadir}/virt-viewer
%endif

%if 0%{?mingw_build_win64} == 1
cp build_win64$MINGW_BUILDDIR_SUFFIX/data/virt-viewer-x64-2.0.msi $RPM_BUILD_ROOT/%{mingw64_datadir}/virt-viewer
%endif
...
%{mingw32_datadir}/virt-viewer/virt-viewer-x86-2.0.msi
...
%{mingw64_datadir}/virt-viewer/virt-viewer-x64-2.0.msi
