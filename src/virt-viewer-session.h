...
struct _VirtViewerSessionClass {
    ...
    gboolean (* open_host) (VirtViewerSession* session, const gchar *host, const gchar *port, const gchar *tlsport, const gchar *password);
    ...
    void (*session_reconnect)(VirtViewerSession *session);
	void (*session_inputstimeout)(VirtViewerSession *session);
...
gboolean virt_viewer_session_open_host(VirtViewerSession* session, const gchar *host, const gchar *port, const gchar *tlsport, const gchar *password);
